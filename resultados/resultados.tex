...
Uma hipótese de melhoria para o cenário em questão é a utilização de técnicas de \textit{oversampling} como o SMOTE\cite{Smote2002} para minimizar as distorções causadas pelo desbalanceamento das classes.

Vale ressaltar que, mesmo diante dos problemas de classificação apresentados, os resultados podem ser considerados plenamente satisfatórios para os três tipos de ato, se confrontarmos os resultados obtidos com a alternativa atual do sistema Normas (classificação 100\% manual).   