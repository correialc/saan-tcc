...
\titulo{\Large{CLASSIFICAÇÃO DOS SEGMENTOS DE ATOS NORMATIVOS ATRAVÉS DO PROCESSAMENTO DE LINGUAGEM NATURAL}}
...
\include{coleta/coleta}
\include{exploratoria/exploratoria}
\include{limpeza/limpeza}
\include{preprocessamento/preprocessamento}
\include{vetorizacao/vetorizacao}
\include{treinamento/treinamento}
